...
## Current milestone: Small Arsenal

This repository proves a local artillery match with destructible terrain, timed turns, movement, pull-back aiming, and five original placeholder weapons. It deliberately has no accounts, networking, bots, menus, progression, or mobile controls.
